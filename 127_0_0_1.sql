...
--
-- Host: 127.0.0.1
-- Generation Time: 08. Des, 2023 10:10 AM
...
ALTER TABLE `reaction`
  ...
  ADD KEY `fk_reaction_bruker_idx` (`bruker`);
...
--
ALTER TABLE `bruker`
  MODIFY `idbruker` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `reaction`
--
ALTER TABLE `reaction`
  MODIFY `idreaction` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=91;
...
--
-- Begrensninger for tabell `reaction`
--
ALTER TABLE `reaction`
  ADD CONSTRAINT `fk_reaction_bruker` FOREIGN KEY (`bruker`) REFERENCES `bruker` (`idbruker`) ON DELETE NO ACTION ON UPDATE NO ACTION;
--
-- Database: `phpmyadmin`
--
...
('root', '[{\"db\":\"mydb\",\"table\":\"bruker\"},{\"db\":\"mydb\",\"table\":\"reaction\"},{\"db\":\"mydb\",\"table\":\"produkter\"},{\"db\":\"mydb\",\"table\":\"bestillinger\"},{\"db\":\"mydb\",\"table\":\"kunder\"},{\"db\":\"mydb\",\"table\":\"debil\"},{\"db\":\"mydb\",\"table\":\"produkt_i_bestilling\"}]');
...
--
-- Dataark for tabell `pma__table_uiprefs`
--

INSERT INTO `pma__table_uiprefs` (`username`, `db_name`, `table_name`, `prefs`, `last_update`) VALUES
('root', 'mydb', 'bruker', '{\"CREATE_TIME\":\"2023-12-05 10:59:39\",\"col_order\":[0,1,2],\"col_visib\":[1,1,1]}', '2023-12-05 10:34:34');
...
('root', '2023-12-08 09:09:51', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"nb\",\"NavigationWidth\":0}');
